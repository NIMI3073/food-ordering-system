...
<section class="ftco-section ftco-wrap-about ftco-no-pb ftco-no-pt align-items-center" style="margin-top: 10px;padding-bottom:10px;position:relative;left:25em;">
    <div class="container">
		<div class="row no-gutters horizontal-inline" style="display:inline">
						...
						<div class="col-md-12">
							<div class="form-group">
								<div class="input-wrap">
									<label class="text-white">Check In Time</label>
									<input type="time" class="form-control book_date" placeholder="Check-In Time">
								</div>
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<div class="input-wrap">
								<label class="text-white ">Check Out Time</label>
									<input type="time" class="form-control book_time" placeholder=" Check-Out-Time">
								</div>
							</div>
						</div>
						...
						<div class="col-md-12">
							<div class="form-group">
								<div class="input-wrap">
									...
									<input type="date" class="form-control book_time" placeholder="Date">
								</div>
							</div>
						</div>
